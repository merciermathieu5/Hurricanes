/* Harnais de validation — Hurricanes de la Caroline (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'CAROLINA',
  taille: 23,
  echantillon: {nom: 'Shane Wright', salaire: 3750000, ct: 1, ov: 80},
  masseSousContrat: 73925000,
  nbSousContrat: 14,
  dateSecours: '8 juillet 2026',
  nbEchus: 9,
  nbBackups: 0,
  masseTotale: 99395000
};
...
(async () => {
  ...
  W.localStorage.removeItem('car_resignatures_v1');
  W.localStorage.removeItem('car_transac_v1');
